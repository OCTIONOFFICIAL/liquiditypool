...
// token deposits are done through NEP-141 ft_transfer_call to the octiswap contract.
#[near_bindgen]
impl FungibleTokenReceiver for octiswap {
    /**
    ...
    pub fn withdraw_token_deposit(
        ...
        if is_contract {
            ext_fungible_token::ft_transfer(
                ...
                amount.into(),
                Some("octiswap withdraw".to_string()),
                token.as_ref(),
